          ...
          <div className="gallery full-width">
              ...
              <div className="item-img">
                <Link href="/project-details2/project-details2-dark">
                  <a className="imago wow animated">
                    <Image src="/img/mobile-app/works/1.jpg" alt="image" />
            ...
            >
              <div className="item-img">
                <Link href="/project-details2/project-details2-dark">
                  <a className="imago wow animated">
                    <Image src="/img/mobile-app/works/2.jpg" alt="image" />
                    <div className="item-img-overlay"></div>
                  </a>
                </Link>
                <div className="cont valign">
            ...
            >
              <div className="item-img">
                <Link href="/project-details2/project-details2-dark">
                  <a className="imago wow animated">
                    <Image src="/img/mobile-app/works/5.jpg" alt="image" />
                    <div className="item-img-overlay"></div>
                  </a>
                </Link>
                <div className="cont valign">
            ...
            >
              <div className="item-img">
                <Link href="/project-details2/project-details2-dark">
                  <a className="imago wow animated">
                    <Image src="/img/mobile-app/works/3.jpg" alt="image" />
                    <div className="item-img-overlay"></div>
                  </a>
                </Link>
                <div className="cont valign">
            ...
            >
              <div className="item-img">
                <Link href="/project-details2/project-details2-dark">
                  <a className="imago wow animated">
                    <Image src="/img/mobile-app/works/6.jpg" alt="image" />
                    <div className="item-img-overlay"></div>
                  </a>
                </Link>
                <div className="cont valign">
            ...
            >
              <div className="item-img">
                <Link href="/project-details2/project-details2-dark">
                  <a className="imago wow animated">
                    <Image src="/img/mobile-app/works/7.jpg" alt="image" />
                    <div className="item-img-overlay"></div>
                  </a>
                </Link>
                <div className="cont valign">
            ...
            >
              <div className="item-img">
                <Link href="/project-details2/project-details2-dark">
                  <a className="imago wow animated">
                    <Image src="/img/mobile-app/works/8.jpg" alt="image" />
                    <div className="item-img-overlay"></div>
                  </a>
                </Link>
                <div className="cont valign">
