                ...
                >
                  <SwiperSlide className="swiper-slide">
                    <div className="item">
                      <div className="icon mb-50">
                        <Image src="/img/mobile-app/qoute.png" alt="" />
                      </div>
                      <div className="text">
                        <p>
                      ...
                      <div className="info">
                        <div className="img">
                          <Image src="/img/mobile-app/clients/1.png" alt="" />
                        </div>
                        <div className="cont">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="item">
                      ...
                      <div className="info">
                        <div className="img">
                          <Image src="/img/mobile-app/clients/2.png" alt="" />
                        </div>
                        <div className="cont">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="item">
                      ...
                      <div className="info">
                        <div className="img">
                          <Image src="/img/mobile-app/clients/3.png" alt="" />
                        </div>
                        <div className="cont">
