        ...
        <div className="row">
          <div className="col-lg-3 col-md-6">
            <div className="item text-center md-mb50">
              <div className="img">
                <Image src="/img/mobile-app/team/1.png" alt="" />
              </div>
              <div className="info">
          ...
          <div className="col-lg-3 col-md-6">
            <div className="item text-center md-mb50">
              <div className="img">
                <Image src="/img/mobile-app/team/2.png" alt="" />
              </div>
              <div className="info">
          ...
          <div className="col-lg-3 col-md-6">
            <div className="item text-center sm-mb50">
              <div className="img">
                <Image src="/img/mobile-app/team/3.png" alt="" />
              </div>
              <div className="info">
          ...
          <div className="col-lg-3 col-md-6">
            <div className="item text-center">
              <div className="img">
                <Image src="/img/mobile-app/team/4.png" alt="" />
              </div>
              <div className="info">
